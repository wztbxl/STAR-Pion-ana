/**************************************************************************
 *
 * $Id: StFmsPoint.h,v 1.1 2020/08/01 23:50:17 zwzhu Exp $
 *
 ...
 *
 * $Log: StFmsPoint.h,v $
 * Revision 1.1  2020/08/01 23:50:17  zwzhu
 * *** empty log message ***
 *
...
public:
    ...
    void print(int option=0);
     ...
     void setdX(double xpos);
     void setdY(double ypos);
     void setdZ(double zpos);
     void setdE(double energy);
     double dx() const;  // x position in cm at which point intersects the sub-detector in local coordinate
     double dy() const;  // y position in cm at which point intersects the sub-detector in local coordinate
     double dz() const;  // y position in cm at which point intersects the sub-detector in local coordinate
     double de() const;  // y position in cm at which point intersects the sub-detector in local coordinate
...
inline void StFmsPoint::setFpsPid(int v) {mFpsPid=v;}
 ...
 inline double StFmsPoint::de() const { return mdE; }
 inline double StFmsPoint::dx() const { return mdX; } // x position in cm at which point intersects the sub-detector.
 inline double StFmsPoint::dy() const { return mdY; } // y position in cm at which point intersects the sub-detector.
 inline double StFmsPoint::dz() const { return mdZ; } // y position in cm at which point intersects the sub-detector.
 inline void StFmsPoint::setdE(double energy) { mdE = energy; }
 inline void StFmsPoint::setdX(double xpos) { mdX = xpos; }
 inline void StFmsPoint::setdY(double ypos) { mdY = ypos; }
 inline void StFmsPoint::setdZ(double zpos) { mdZ = zpos; }

 inline double StFmsPoint::Chi2() const { return mChi2; }
 inline double StFmsPoint::RX1() const { return mRX1; }
 inline double StFmsPoint::RX2() const { return mRX2; }
 inline double StFmsPoint::Re1() const { return mRe1; }
 inline double StFmsPoint::Re2() const { return mRe2; }
 inline void StFmsPoint::setChi2(double chi2) { mChi2 = chi2; }
 inline void StFmsPoint::setRX1(double rx1) { mRX1 = rx1; }
 inline void StFmsPoint::setRX2(double rx2) { mRX2 = rx2; }
 inline void StFmsPoint::setRe1(double re1) { mRe1 = re1; }
 inline void StFmsPoint::setRe2(double re2) { mRe2 = re2; }
