...
//using cross-ratio method with sin(phi) fit
  Int_t crAnXf( Float_t elow = 38, Float_t ehigh = 43, Float_t mlow = 0.20, Float_t mhigh = 0.25, Int_t fillnum = 15315, char* infile="/star/u/zwzhu/01zwzhu/Run11/byfill/ipi0jetcor_stfms_Fill15315.root" ){
...
//        }
	...
	sprintf(resultname,"AN2_Fill%d_mass%.2fto%.2fGeV_E%.1fto%.1fGeV.txt",fillnum,mlow,mhigh,elow,ehigh);
	sprintf(resultname2,"ANy2_Fill%d_mass%.2fto%.2fGeV_E%.1fto%.1fGeV.txt",fillnum,mlow,mhigh,elow,ehigh);
...
//	Int_t TrigBitsSelect = JP2;
	Int_t TrigBitsSelect = JP+HiTow+clbit;
        Char_t trigselect[600];
//        sprintf(trigselect,"(TrigBits&%d&&Corr==0&&TMath::Abs(vertexzyuxi+0)<68)&&pipt>2",TrigBitsSelect);
//        sprintf(trigselect,"Corr==0&&TMath::Abs(vertexzyuxi+0)<68&&pipt>2&&((TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.875&&(phid1<9.1||phid2<9.1))||(TrigBits&%d&&pipt>2.05&&(phid1>9.1&&phid2>9.1))||(TrigBits&%d&&pipt>0.92)||(TrigBits&%d&&pipt>1.61)||(TrigBits&%d&&pipt>1.72)||(TrigBits&%d&&pipt>2.53))",JP1,JP2,JP2,SmlBd1,SmlBd2,LrgBd1,LrgBd2);
 //20200427 
 sprintf(trigselect,"Corr==0&&TMath::Abs(vertexzyuxi+0)<68&&pipt>2&&((TrigBits&%d&&pipt>2.7)||(TrigBits&%d&&pipt>4.3&&(phid1<9.1||phid2<9.1))||(TrigBits&%d&&pipt>4.3&&(phid1>9.1&&phid2>9.1))||(TrigBits&%d&&pipt>1.6)||(TrigBits&%d&&pipt>2.7)||(TrigBits&%d&&pipt>2.7)||(TrigBits&%d&&pipt>4.3))",JP1,JP2,JP2,SmlBd1,SmlBd2,LrgBd1,LrgBd2);
