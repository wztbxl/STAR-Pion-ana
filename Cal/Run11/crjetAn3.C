...
//using cross-ratio method with sin(phi) fit
  Int_t crjetAn3( Float_t elow = 48, Float_t ehigh = 65, Float_t mlow = 1.00, Float_t mhigh = 1.00, Int_t fillnum = 15315,char* infile="/star/u/zwzhu/01zwzhu/Run11/byfill/ipi0jetcor_stfms_Fill15315.root" ){
...
double e0    =   9.30129 ;    
double e1    = -0.180525 ;
double e2    =0.00130724 ;  
double e3  =    0.739412  ; 
*/
double	e0	=	-0.243595	;
double	e1	=	-0.083786	;
double	e2	=	0.000420771	;
double	e3	=	0.813897	;


double uept0   =       14.9446 ;    
double uept1   =    -0.0736996 ;    
double uept2   =   0.000245953 ;    
double uept3   =      0.227344 ;    

double uee0   =       51.0179;   
double uee1   =    -0.0573496;   
double uee2   =     0.0115968;   
double uee3   =       2.73998;   
...
//        sprintf(trigselect,"(TrigBits&%d&&TMath::Abs((vertexzyuxi+0)<68))&&fjetntow>2",TrigBitsSelect);
        Char_t ptnew[400];
	...
	sprintf(trigselect,"TMath::Abs(vertexzyuxi+0)<68&&fjetntow>2&&((TrigBits&%d&&fjpT>2.7)||(TrigBits&%d&&fjpT>4.3))",JP1,JP2);
	Char_t htitle[200];
	Char_t htitley[200];
