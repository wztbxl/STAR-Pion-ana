...
//        }
	...
	sprintf(resultname,"PtAN_Fill%d_mass%.2fto%.2fGeV_E%.1fto%.1f_Pt%.1fto%.1fGeV.txt",fillnum,mlow,mhigh,elow,ehigh,ptlow,pthigh);
	sprintf(resultname2,"PtANy_Fill%d_mass%.2fto%.2fGeV_E%.1fto%.1f_Pt%.1fto%.1fGeV.txt",fillnum,mlow,mhigh,elow,ehigh,ptlow,pthigh);
...
//	Int_t TrigBitsSelect = JP2;
	Int_t TrigBitsSelect = JP+HiTow+clbit;
     ...
     //   sprintf(trigselect,"(TrigBits&%d&&Corr==0&&TMath::Abs(vertexzyuxi+36)<90)&&pipt>%.1f&&pipt<%.1f",TrigBitsSelect,ptlow,pthigh);
sprintf(trigselect,"pipt>%.1f&&pipt<%.1f&&Corr==0&&TMath::Abs(vertexzyuxi+18.4)<93.4&&((TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.765)||(TrigBits&%d&&pipt>3.68)||(TrigBits&%d&&pipt>1.26)||(TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.2)||(TrigBits&%d&&pipt>2.53)||(TrigBits&%d&&pipt>1.26)||(TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.76))",ptlow,pthigh,JP0,JP1,JP2,SmlBd0,SmlBd1,SmlBd2,SmlBd22,LrgBd0,LrgBd1,LrgBd2);
	Char_t htitle[200];
	Char_t htitley[200];
