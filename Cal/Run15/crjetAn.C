...
//using cross-ratio method with sin(phi) fit
  Int_t crjetAn( Float_t elow = 48, Float_t ehigh = 53, Float_t mlow = 1.00, Float_t mhigh = 1.00, Int_t fillnum = 18790,char* infile="/star/u/jiachen/jiachen/zwzhu/data/byfill/ipi0jetcor_stfms_Fill18790.root" ){
...
//	Int_t TrigBitsSelect = JP+HiTow+clbit;
	...
	sprintf(trigselect,"TMath::Abs(vertexzyuxi+18.4)<93.4&&fjetntow>0&&((TrigBits&%d&&fjpT>1.84)||(TrigBits&%d&&fjpT>2.765)||(TrigBits&%d&&fjpT>3.68))&&%s",JP0,JP1,JP2,Rof);
