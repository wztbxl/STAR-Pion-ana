...
//using cross-ratio method with sin(phi) fit
  Int_t crAnXf( Float_t elow = 38, Float_t ehigh = 43, Float_t mlow = 0.20, Float_t mhigh = 0.25, Int_t fillnum = 18753, char* infile="/star/u/zwzhu/01zwzhu/Run15/byfill/ipi0jetcor_stfms_Fill18753.root" ){
...
//        }
	...
	sprintf(resultname,"AN_Fill%d_mass%.2fto%.2fGeV_E%.1fto%.1fGeV.txt",fillnum,mlow,mhigh,elow,ehigh);
	sprintf(resultname2,"ANy_Fill%d_mass%.2fto%.2fGeV_E%.1fto%.1fGeV.txt",fillnum,mlow,mhigh,elow,ehigh);
...
//	Int_t TrigBitsSelect = JP2;
	Int_t TrigBitsSelect = JP+HiTow+clbit;
        Char_t trigselect[500];
 //       sprintf(trigselect,"(TrigBits&%d&&Corr==0&&TMath::Abs(vertexzyuxi+36)<90)&&pipt>2",TrigBitsSelect);
sprintf(trigselect,"Corr==0&&TMath::Abs(vertexzyuxi+18.4)<93.4&&pipt>2&&((TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.765)||(TrigBits&%d&&pipt>3.68)||(TrigBits&%d&&pipt>1.26)||(TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.19)||(TrigBits&%d&&pipt>2.53)||(TrigBits&%d&&pipt>1.26)||(TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.76))",JP0,JP1,JP2,SmlBd0,SmlBd1,SmlBd2,SmlBd22,LrgBd0,LrgBd1,LrgBd2);
//sprintf(trigselect,"Corr==0&&TMath::Abs(vertexzyuxi+36)<90&&pipt>2&&((TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.765)||(TrigBits&%d&&pipt>3.68)||(TrigBits&%d&&pipt>1.26)||(TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.2)||(TrigBits&%d&&pipt>1.26)||(TrigBits&%d&&pipt>1.84)||(TrigBits&%d&&pipt>2.76))",JP0,JP1,JP2,SmlBd0,SmlBd1,SmlBd2,LrgBd0,LrgBd1,LrgBd2);
	Char_t htitle[200];
	Char_t htitley[200];
